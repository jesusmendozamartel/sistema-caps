...
<?
   ...
   if($_REQUEST["cicatriz"]=='1')
   {
         ...
         $iduser = $_REQUEST["iduser"];
         $cadena = "update atencion set bloqueado='0' where idatencion ='$idatencion'";
...
<div class="contenido">
 ...
 <table width="100%">
  ...
  <? $codatencion = retorna_cadena($_REQUEST["idatencion"],"idatencion",1,"atencion"); 
    ...
    ?>
  <tr><h2>Estas suguro de desbloquear a la atenci&oacute;n</h2><h1><font color='red'><? echo $codatencion; ?></font></h1> 
