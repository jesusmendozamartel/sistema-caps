...
<?
   ...
   if($_REQUEST["cicatriz"]=='1')
   {
         ...
         $iduser = $_REQUEST["iduser"];
         $cadena = "delete from atencion where idatencion ='$idatencion'";
...
<div class="contenido">
 ...
 <table width="100%">
  ...
  <? $codatencion = retorna_cadena($_REQUEST["idatencion"],"idatencion",1,"atencion"); 
    ...
    ?>
  <tr><h2>Estas seguro de eliminar a la atenci&oacute;n</h2><h1><font color='red'><? echo $codatencion; ?></font></h1> 
