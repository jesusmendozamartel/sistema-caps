...
<font face="arial" size="2">[+] <a href="responsables_op.php?&op=nuevo">Agregar Responsable</a></font><br>
 <div class="scroll2">
 <table width='100%'>
 <tr bgcolor='#766508'>
 ...
 <td><font size='2' color='#ffffff'><b>Control</td>
 ...
 <?
    ...
    while ($registro = mysql_fetch_array($tabla))
    {
	 ...
	 echo "<td>";
	 echo "<a href='responsables_op.php?&op=editar&idresponsable=$registro[0]'><img border='0' src='imagenes/editar.gif' height='15'><font face='2' face='arial'>[Editar]</font></a>";
	 echo "</td>";	 
	 echo "</tr>";
